...
public class RobotContainer {
  ...
  private final Blower m_storage = new Blower();
...
public RobotContainer() {
  ...
  Shuffleboard.getTab("Storage").add("Turn In Storage", new InstantCommand(m_storage::blow, m_storage));
  Shuffleboard.getTab("Storage").add("Turn Out Storage", new InstantCommand(m_storage::stop, m_storage));
